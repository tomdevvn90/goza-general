...
// $slidesToShow     = $carousel_setting['slidesToShow'] ? 

// echo "<pre>";
// echo print_r($testominials);
// echo "</pre>";
...
// echo "<pre>";
// echo print_r($data_carousel);
// echo "</pre>";
?>
<div id="<?php echo $id; ?>" class="be-testominials-block <?php echo $align_class; ?>"  data-carousel='<?= json_encode($data_carousel) ?>'> 
